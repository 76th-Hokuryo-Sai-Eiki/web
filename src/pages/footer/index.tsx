...
export default function Footer() {
    ...
    return (
        <Card
            className="items-center rounded-b-none bg-default-50 px-[1rem] pt-4 md:px-[max(2rem,10%-100px)]"
            radius="none"
            shadow="none"
        >
            <CardBody className="container p-0">
                <div className="grid w-full items-center gap-4 [grid-template-columns:auto_auto] [grid-template-rows:auto_auto] sm:[grid-template-columns:auto_auto_auto]">
