...
export default [
    {
        ...
        map_link: encodeURI(
            `https://www.google.com/maps/dir/仙台国際センター、〒980-0856+宮城県仙台市青葉区青葉山/${siteConfig.event.location.address.join("")}`,
        ),
    ...
    },
    {
        ...
        sub_link:
            "https://www.kotsu.city.sendai.jp/subway/station/station.html",
        map_link: encodeURI(
            `https://www.google.com/maps?ll=38.261176,140.868073&z=14&t=m&hl=ja&gl=JP&mapclient=embed&saddr=広瀬通駅、宮城県仙台市青葉区&daddr=${siteConfig.event.location.address.join("")}&dirflg=d`,
        ),
    ...
    },
    {
        ...
        map_link: encodeURI(
            `https://www.google.com/maps/dir/仙台駅内郵便局、〒980-0021+宮城県仙台市青葉区中央１丁目１−１/${siteConfig.event.location.address.join("")}`,
        ),
    ...
    },
    {
        ...
        map_link: encodeURI(
            `https://www.google.com/maps/dir/二高・宮城県美術館前、〒980-0855+宮城県仙台市青葉区川内澱橋通/${siteConfig.event.location.address.join("")}−１`,
        ),
